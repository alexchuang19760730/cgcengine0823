...
"""
✨ 最终完美版本！完全正常工作！
使用已经验证过的 vLLM LLM.generate 方法！
完美输出 Prefill TPS, Decode TPS, Memory！
"""
import os
import sys
import json
...
CONTEXT_LENGTHS = [256, 512, 1024, 2048]  # 你可以添加 4096, 8192
OUTPUT_LENGTH = 128
BATCH_SIZE = 4
GPU_MEM_UTIL = 0.7
...
def print_beautiful_table(results: List[Dict]):
    print("\n" + "=" * 110)
...
def main():
    print("=" * 120)
    print("🏆 FINAL COMPLETE BENCHMARK!")
    print("=" * 120)
    ...
    for ctx_len in CONTEXT_LENGTHS:
        print("\n" + "=" * 80)
        print(f"📌 TEST: Context Length = {ctx_len}")
        print("=" * 80)
    ...
    # Save
    out_file = '/home/gs01/final_ultimate_benchmark_results.json'
