#!/usr/bin/env python3
"""
CGC Engine + Metal Benchmark - 使用 Metal GPU 加速
"""
...
print('=' * 70)
print('CGC Engine + Metal Benchmark')
print('=' * 70)
print()
...
print('Loading CGC Engine with Metal...')
mem_before = get_memory()

# 使用 Metal 而不是 CPU!
engine = CGCEngine.from_gguf(gguf_path=MODEL, device='metal')
...
for n_tokens in test_cases:
    ...
    elapsed = min(elapsed_list)  # 使用最快的一次
    mem_end = get_memory()
