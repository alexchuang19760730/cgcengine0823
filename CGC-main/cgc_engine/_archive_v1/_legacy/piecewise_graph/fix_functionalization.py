...
from cgc_engine.utils import is_func, magi_logger

from cgc_engine._legacy.magi_depyf.timeline import emit_pass_lifecycle
from cgc_engine.passes.pass_base import MagiInductorPass
