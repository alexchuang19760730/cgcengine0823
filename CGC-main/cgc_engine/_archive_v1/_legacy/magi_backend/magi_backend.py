...
if TYPE_CHECKING:
    from cgc_engine.utils import OrderedSet
...
import cgc_engine.utils.envs as envs
from cgc_engine.config import CompileConfig, CompileMode, CudaGraphMode, inductor_compile_config_hash, magi_cache_dump_path
from cgc_engine._legacy.magi_depyf.timeline import observe_lifecycle, observe_lifecycle_context
from cgc_engine.offload.offload_warpper import OffloadWrapper

from cgc_engine.utils import compilation_counter, compute_code_hash, compute_hash, magi_logger
from cgc_engine.utils.visualize import save_fx_graph_visualization
...
class CompilerManager:
    ...
    def compile_context(self, runtime_shape: int | None = None, graph_index: int | None = None):
        ...
        from cgc_engine.passes import pass_context
...
class MagiBackend:
    ...
    def _configure_custom_passes(self):
        from cgc_engine.passes import CustomJointGraphPartitionFn, FullGraphPassManager, PostGradPassManager
