...
// yet, but the struct must exist for the Metal shader source to compile.
typedef struct {
    int32_t  nei0;
    int32_t  nei1;
    uint64_t nbi1;
    uint64_t nbi1o;  // ids_orig stride (original expert id)
    int32_t  ne00;
    int32_t  ne01;
    int32_t  ne02;
    uint64_t nb00;
    uint64_t nb01;
    uint64_t nb02;
    uint64_t nb01u;  // up-weight row stride
    uint64_t nb02u;  // up-weight expert stride
    int32_t  ne10;
    int32_t  ne11;
    int32_t  ne12;
    int32_t  ne13;
    ...
    bool     has_g_scale;
    bool     has_u_scale;
    // fused-down fields (only used by the iq3_xxs fused-down path)
    int32_t  ne00d;   // K  (n_ff)
    int32_t  ne01d;   // Nout (n_embd)
    int32_t  ne02d;   // n_experts (>0 enables fused-down)
    uint64_t nb01d;   // down row stride
    uint64_t nb02d;   // down expert stride
} ggml_metal_kargs_mul_mv_id_glu;
...
typedef struct {
    ...
    int32_t  ne2;
    uint64_t nbi1;
} ggml_metal_kargs_mul_mv_id_glu_scale;
