...
common_params_context common_params_parser_init(common_params & params, llama_example ex, void(*print_usage)(int, char **)) {
    ...
    add_opt(common_arg(
        {"-expert-cache"}, "BYTES",
        string_format("expert streaming cache budget for MoE weights, in bytes (0 = off; default: %zu)", params.expert_cache_bytes),
        [](common_params & params, const std::string & value) {
            params.expert_cache_bytes = std::stoull(value);
        }
