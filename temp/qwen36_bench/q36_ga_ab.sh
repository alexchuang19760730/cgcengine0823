#!/bin/bash
# §13.102: r4q4la (GatedAttn fp16) vs r4q4la_ga (GatedAttn all-q4) 128 tok 交錯 A/B
...
PROFILE=prime-agent-worktrees/qwen36-r4q4la.gturbo/profiles/top80_code_prose.json
...
for R in 1 2 3 4; do
  if [ $((R % 2)) -eq 1 ]; then M=prime-agent-worktrees/qwen36-r4q4la.gturbo; L=r4q4la; else M=prime-agent-worktrees/qwen36-r4q4la_ga.gturbo; L=r4q4la_ga; fi
  echo "=== R$R $L ==="
