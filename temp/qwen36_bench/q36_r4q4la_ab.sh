#!/bin/bash
# §13.101 附錄: r4q4 (linear_attn fp16) vs r4q4la (linear_attn all-q4) 128 tok 交錯 A/B
...
PROFILE=prime-agent-worktrees/qwen36-r4q4.gturbo/profiles/top80_mix.json
...
for R in 1 2 3 4; do
  if [ $((R % 2)) -eq 1 ]; then M=prime-agent-worktrees/qwen36-r4q4.gturbo; L=r4q4; else M=prime-agent-worktrees/qwen36-r4q4la.gturbo; L=r4q4la; fi
  echo "=== R$R $L ==="
