#!/bin/bash
# qwen36 MTP reject-fix on/off A/B: off → on → off → on, msg_code, 128 tok
...
echo "=== R1 off ==="; run_off r1 "$OUT/q36_fixed_r1_off.log"
echo "=== R2 on ===";  run_on  r2 "$OUT/q36_fixed_r2_on.log"
echo "=== R3 off ==="; run_off r3 "$OUT/q36_fixed_r3_off.log"
echo "=== R4 on ===";  run_on  r4 "$OUT/q36_fixed_r4_on.log"
echo "ALL DONE"
